...
# USAGE: ./make_slim_gradual_contraction_age1.sh [Na] [Nb] [nF] [FMu]
...
nF=${3}
# Set Mu, the fold of mutation rate
FMu=${4}

# Make script
cat > slim_gradual_contraction_age1_${Na}Na_${Nb}Nb_${nF}nF_${FMu}FMu.slim << EOM
...
initialize() {
	...
	//cat("Genome length:"+seqLength+"\n");	
        ...
        initializeMutationRate(4.258e-9*${FMu});
